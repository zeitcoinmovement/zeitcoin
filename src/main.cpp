...
int generateMTRandom(unsigned int s, int range)
{
    ...
    random::uniform_int_distribution<> dist(250000, range);
    return dist(gen);
}
...
static const int CUTOFF_HEIGHT = 120960;    // Height at the end of 6 weeks
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    nSubsidy += generateMTRandom(seed, 1000000) * COIN;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x8acd97632c53f94d63a5cdaf7d8e45346bff4efd10c81541b4578d5c755a297a"));
